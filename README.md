...
The goal of this project is to create a portfolio using React. 

This application has been deployed on GitHub Pages using the [Create React App Docs on GitHub Pages](https://create-react-app.dev/docs/deployment/#github-pages) instructions to create a build that is deployable.
